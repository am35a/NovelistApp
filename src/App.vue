        ...
        <template v-if="isSectionPlayer">
            ...
            <section v-show="!isSectionShare && !isSectionRate && !isSectionDescription && !isSectionContents" class="player">
                ...
                <div class="player-controls">
                    ...
                    <template v-if="playerPlayPauseDisabled">
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"></svg>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            playerPlayPauseDisabled() {
                return this.playRewindFrontDisable
            }
