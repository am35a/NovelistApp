<template>
    <section>
        <div class="splash text-center">
            ...
            <div class="d-none-limit-height text-uppercase display-5">
        ...
        <div class="btn-si">
            <button @click="$parent.signingIn" class="button-block button-light button-scope button-round" type="button">
                Sign In
            </button>
        </div>
    </section>
